...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false" class="flex flex-col bg-slate-400 flex-shrink-0 w-full text-gray-700 md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
